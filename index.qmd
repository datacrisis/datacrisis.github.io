...
I also dabble in research as a Graduate Student Researcher at the [AI4CE Lab](https://ai4ce.github.io) @ New York University, working with Professor Chen Feng primarily on *active robotic perception*. In the past, I had a blast working on Autonomous UAVs with Dr. Swee King Phang at Taylor's University as an undergraduate (good ol' times!).

In terms of professional work, I was a Data Scientist @ MoneyLion for two exciting years (>$1B served annually) as part of the (amazing) Instacash team, and I had a blast this summer serving as a Data Science Intern at IBM's Chief Analytics Office (go CAO! 🇺🇸). I'll also be joining Nokia Bell Labs this Spring as an intern for robotics.

Other than that I am serving as the Teaching Assistant for the undergraduate Robot Vision course for Spring 2024. If you're taking the course, feel free to reach out!
:::
...
- **Jan 2024**:
    - Serving as a Teaching Assistant for the Robot Vision (ROB-UY 3203) in Spring 2024.
    - Joined Nokia Bell Labs as an intern for robotics.
- **November 2023**:
    - Preprint of a recent work of mine along a few other collaborators at AI4CE is now live! [SO-NeRF: Active View Planning for NeRF using Surrogate Objectives](https://ai4ce.github.io/SO-NeRF/)
- **September 2023**:
    - Served as a Teaching Assistant for the Fall 2023 Robot Perception (ROB-GY 6203) course with 90 wonderful students.
- **May 2023**:
